...
struct CFilterMode2 final : public CFilterMode
{
  bool Encrypted;
  unsigned GroupIndex;
...
class CRepackInStreamWithSizes final :
...
class CCryptoGetTextPassword final :
